...
Begin VB.Form frmSListAllMenu 
   ...
   Begin MSAdodcLib.Adodc item 
      ...
      _Version        =   393216
   End
   Begin MSDataGridLib.DataGrid DataGridItem 
      Bindings        =   "frmSListAllMenu.frx":0000
      Height          =   5655
      Left            =   3960
      TabIndex        =   4
      Top             =   2760
   ...
   End
End
Attribute VB_Name = "frmSListAllMenu"
